...
I_link1 = [0 0 0;
        0 1/12*m_link*l^2 0;
        0 0 1/12*m_link*l^2]
I_link2 = [cos(q1) -sin(q1) 0;
    sin(q1) cos(q1) 0;
    0 0 1]*I_link1*[cos(q1) -sin(q1) 0;
    sin(q1) cos(q1) 0;
    0 0 1]'
I_link3 = [cos(q1+pi/2) -sin(q1+pi/2) 0;
    sin(q1+pi/2) cos(q1+pi/2) 0;
    0 0 1]*I_link1*[cos(q1+pi/2) -sin(q1+pi/2) 0;
    sin(q1+pi/2) cos(q1+pi/2) 0;
    0 0 1]'
I_link4 = [cos(q1+pi/2+q2) -sin(q1+pi/2+q2) 0;
    sin(q1+pi/2+q2) cos(q1+pi/2+q2) 0;
    0 0 1]*I_link1*[cos(q1+pi/2+q2) -sin(q1+pi/2+q2) 0;
    sin(q1+pi/2+q2) cos(q1+pi/2+q2) 0;
    0 0 1]'
